        ...
        <nav aria-label="Footer" className="space-y-3">
          <ul className="flex flex-wrap gap-x-6 gap-y-2">
            {primaryNav.map((item) => (
              <li key={item.href}>
                <Link
                  href={item.href}
                  className="text-sm text-[var(--color-ink)] hover:text-[var(--color-accent)] transition-colors py-2 inline-flex items-center"
                >
                  {item.label}
                </Link>
              </li>
          ...
          <ul className="flex flex-wrap gap-x-6 gap-y-2">
            <li>
              <Link
                href="/privacy"
                className="text-xs text-[var(--color-ink-subtle)] hover:text-[var(--color-accent)] transition-colors py-2 inline-flex items-center"
              >
                Privacy
              </Link>
            </li>
